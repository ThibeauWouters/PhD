...
#     # Compute losses
#     train_loss, grads = apply_model(state, X_train, y_train)
#     if X_val is not None:
#         val_loss, grads = apply_model(state, X_val, y_val)
...
# # @jax.jit
# def train_loop(state: TrainState, X_train, y_train, X_val = None, y_val = None, config = None):
...
#         # Do a single step
#         state, train_loss, val_loss = train_step(state, X_train, y_train, X_val, y_val)
#         # Save the losses
